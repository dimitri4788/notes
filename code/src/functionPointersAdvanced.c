/*
 * Author: Not Deep Aggarwal, got it from somewhere online
 */
...
int main(int argc, char **argv)
{
    if(argc < 2)
    {
        printf("Usage: ./functionPointersAdvanced <a list of numbers>\n");
        printf("    For example: ./functionPointersAdvanced 4 55 8 1 9\n");
        exit(1);
    }
